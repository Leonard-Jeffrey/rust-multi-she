...
use crate::{SHE, KeyGenParam, PriKey, PubParam, BigInt}; 
...
impl Encryption<PriKey, PubParam, u128, BigInt> for SHE {
...
impl Decryption<PriKey, BigInt, BigInt> for SHE {
...
impl Homomorphism<PriKey, PubParam, BigInt, usize> for SHE {
